...
public partial class GameEntity {
    ...
    public DefaultNamespace.Components.Asset asset { get { return (DefaultNamespace.Components.Asset)GetComponent(GameComponentsLookup.Asset); } }
    ...
    public void AddAsset(string newName) {
        ...
        var component = (DefaultNamespace.Components.Asset)CreateComponent(index, typeof(DefaultNamespace.Components.Asset));
