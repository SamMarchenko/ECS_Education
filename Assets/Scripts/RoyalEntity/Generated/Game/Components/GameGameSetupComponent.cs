...
public partial class GameContext {
    ...
    public GameEntity SetGameSetup(DefaultNamespace.GameSetup newValue) {
        if (hasGameSetup) {
    ...
    public void ReplaceGameSetup(DefaultNamespace.GameSetup newValue) {
...
public partial class GameEntity {
    ...
    public void AddGameSetup(DefaultNamespace.GameSetup newValue) {
